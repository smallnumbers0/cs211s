...
public class PartTimeEmployee extends Employee {
	...
	public static class HourComparator implements Comparator<PartTimeEmployee> {
		public int compare(PartTimeEmployee emp1, PartTimeEmployee emp2) {
			return Integer.compare(emp1.numHours, emp2.numHours);
		}
	}
